...
const Main = () => {
  ...
  const handleClickCartData = (cartData) => {
    ...
    if (credit > 20) {
      toast.error("Oops! You can't select this course");
      return;
    }
  ...
  return (
    <main className="md:max-w-2xl lg:max-w-4xl  xl:max-w-7xl 2xl:max-w-screen-2xl md:mx-auto my-8 md:my-12 mx-8">
      <h1 className="text-center text-2xl md:text-4xl font-bold mb-8">
        Course Registration
      </h1>
      <ToastContainer></ToastContainer>
      <section className="flex flex-col-reverse md:grid grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4">
